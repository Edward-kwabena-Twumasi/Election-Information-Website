...
const Quote=(props)=>{
    ...
    return(
        <div className="lg:flex  w-full  p-10 justify-between h-50">
            <div className={"quote self-center lg:w-1/2 shadow-lg mb-4 bg-slate-800 text-white  flex flex-col     p-10"}>
            ...
            <div className={"quote self-center  lg:w-1/2 shadow-lg text-slate-800 bg-white  flex flex-col     p-10"}>
